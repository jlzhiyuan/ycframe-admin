var vueDraggableResizable = moduleinit({
	url:'/components/vueDraggableResizable/vueDraggableResizable.html', 
	el:'#vueDraggableResizable',
...
//	              this.zIndex = Number(this.zIndex) + Number(this.number);
	              this.zIndex = 9999;
	            ...
	            elementDown (e) {
	              ...
	              if (this.$el.contains(target)) {
	                ...
	                var that = this;
	                addEvent(document.documentElement, that.eventsFor.move, this.move)
	                addEvent(document.documentElement, that.eventsFor.stop, this.handleUp)
	              }
	            },
	            calcDragLimits () {
	              return {
	            ...
	            deselect (e) {
	              ...
	              if (!this.$el.contains(target) && !regex.test(target.className)) {
	                ...
	                this.zIndex = 999;
	                var that = this;
	                removeEvent(document.documentElement, that.eventsFor.move, this.handleResize)
	              }
	              this.resetBoundsAndMouseState()
	            },
	            ...
	            handleDown (handle, e) {
	              ...
	              var that = this;
	              addEvent(document.documentElement, that.eventsFor.move, this.handleResize)
	              addEvent(document.documentElement, that.eventsFor.stop, this.handleUp)
	            },
	            calcResizeLimits () {
	              let minW = this.minW
	          ...
	          computed: {
	            style () {
	              return {
	                ...
	                zIndex: this.zIndex,
	                ...(this.dragging && this.disableUserSelect ? this.userSelectNone : this.userSelectAuto)
	              }
	            },
	            actualHandles () {
