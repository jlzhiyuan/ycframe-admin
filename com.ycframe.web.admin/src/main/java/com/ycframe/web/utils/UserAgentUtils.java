...
public class UserAgentUtils {
	...
	public static String getBorderType(String userAgent) {
		...
		String borderType = type.getName();
	...
	public static String getBorderGroup(String userAgent) {
		...
		String browerGroup = group.getName();
	...
	public static String getBrowserManufacturer(String userAgent) {
		...
		if(browser == null)
			return "";
		Manufacturer facturer = browser.getManufacturer();
		if(facturer==null){
			return "";
		}
		
		String browserManufacturer = facturer.getName();
	...
	public static String getBorderRenderingEngine(String userAgent) {
		...
		String renderingEngine = engine.name();
	...
	public static String getBrowserVersion(String userAgent) {
		...
		String borderVersion = version.toString();
